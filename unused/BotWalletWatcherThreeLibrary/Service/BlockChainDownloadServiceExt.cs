...
namespace BotWalletWatcher
{
    public class BlockChainDownloadServiceExt
    {
        ...
        public BlockChainDownloadServiceExt(
                            ...
                            IBlockChainPositionService blockChainPositionService,
                            PulseService pulseService)
        {
            FileSaveService = fileSaveService;
            BlockChainPositionService = blockChainPositionService;
            PulseService = pulseService;
        ...
        public IBlockChainPositionService BlockChainPositionService { get; }
        ...
        public async Task ExecuteDownload()
        {
            ...
            while (isContinue)
            {
                int localPosition = await BlockChainPositionService.GetLocalPosition();
                uint nodePosition = await BlockChainPositionService.GetNodePosition();
