...
namespace ExchangeLemonCore.Migrations
{
    ...
    [Migration("20180811015612_IndexOnTransaction")]
    partial class IndexOnTransaction
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlueLight.Main.Student", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("StudentsOriginal");
                });

            modelBuilder.Entity("BlueLight.Main.StudentThree", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ExchangeLemonCore.Data.AddressFive", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("StudentFiveId");

                    b.HasKey("Id");

                    b.HasIndex("StudentFiveId");

                    b.ToTable("Addresses");
                });

            modelBuilder.Entity("ExchangeLemonCore.Data.Park", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ExchangeLemonCore.Data.StudentFive", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ExchangeLemonCore.Data.Tree", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ExchangeLemonCore.Data.TreePark", b =>
                {
                    b.Property<int>("TreeId");

                    b.Property<int>("ParkId");

                    b.HasKey("TreeId", "ParkId");
            ...
            modelBuilder.Entity("ExchangeLemonCore.Data.AddressFive", b =>
                {
                    b.HasOne("ExchangeLemonCore.Data.StudentFive")
                        .WithMany("Address")
                        .HasForeignKey("StudentFiveId");
                });

            modelBuilder.Entity("ExchangeLemonCore.Data.TreePark", b =>
                {
                    b.HasOne("ExchangeLemonCore.Data.Park", "Park")
                        .WithMany("TreeParks")
                        .HasForeignKey("ParkId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ExchangeLemonCore.Data.Tree", "Tree")
                        .WithMany("TreeParks")
