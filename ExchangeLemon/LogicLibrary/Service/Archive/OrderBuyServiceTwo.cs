...
//{
//    public class OrderBuyServiceTwo
//    {
...
//        public OrderBuyServiceTwo(OrderPopulateService orderPopulateService,
//        AccountTransactionService orderPopulateAccountService,
//        IContextSaveService contextSaveService,
//        IOrderMatchService orderMatchService)
//        {
//            this.orderPopulateService = orderPopulateService;
//            this.orderPopulateAccountService = orderPopulateAccountService;
...
//        void MatchOrderTwo(Order oppositeOrder)
//        {
//            OrderBuyMatchOrderService.AddHold(buyer, inputOrder);
//            var s = new OrderBuyMatchOrderService();
//            s.ExecuteTwo(oppositeOrder, inputOrder, buyer);
//        }
...
//            orderPopulateAccountService.Execute(inputOrder, transaction, buyer, seller);
