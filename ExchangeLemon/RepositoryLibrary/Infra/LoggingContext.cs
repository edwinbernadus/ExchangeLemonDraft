...
namespace BlueLight.Main
{
    ...
    public class LoggingContext : DbContext
    {
        ...
        //public static string connStringLog = "Data Source=.; Initial Catalog=WaterBearLogDev; Integrated Security=True; MultipleActiveResultSets=False;";
        public static string connStringLog = "";
        public static LoggingContext Generate()
        {
            var connString = connStringLog;
            var optionsBuilder = new DbContextOptionsBuilder<LoggingContext>();
            optionsBuilder.UseSqlServer(connString);
            var context = new LoggingContext(optionsBuilder.Options);
        ...
        //public DbSet<LogMvc> LogMvcs { get; set; }
        //public DbSet<LogVisit> LogVisits { get; set; }
        //public DbSet<LogReceive> LogReceives { get; set; }
        ...
        public DbSet<LogHttpRaw> LogHttpRaws { get; set; }

        public DbSet<LogReceiveRaw> LogReceiveRaws { get; set; }
        public DbSet<LogReceiveAddress> LogReceiveAddresses { get; set; }
        public DbSet<LogReceiveAddressDetail> LogReceiveAddressDetails { get; set; }
