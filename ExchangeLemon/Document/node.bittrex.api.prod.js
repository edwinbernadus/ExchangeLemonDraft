  ...
  var start,
    request_options = {
      ...
      headers: {
        ...
        'From': 'bot_trade@server.com'
      }
    };

    // this.tapi = 'http://localhost:5000/api/';
    // this.api = 'http://localhost:5000/api/';
  var opts = {
    // baseUrl: 'https://bittrex.com/api/v1.1',
    // baseUrlv2: 'https://bittrex.com/Api/v2.0',
    baseUrl: 'https://exchangekirincore.azurewebsites.net/api/v1',
    baseUrlv2: 'http://localhost:5000/api/v2',
    // websockets_baseurl: 'wss://socket.bittrex.com/signalr',
    // websockets_baseurl: 'wss://localhost:56650/signalr',
    // websockets_baseurl: 'wss://localhost:5000/ws',
    websockets_baseurl: 'http://localhost:5000/api/v1',
